...
if ( $FD->sql()->conn() )
{
    ...
    $config_arr['cfg_videobgcolor'] =  ( $config_arr['cfg_videobgcolor'] );
    $config_arr['cfg_bgcolor1'] =  ( $config_arr['cfg_bgcolor1'] );
    $config_arr['cfg_bgcolor2'] =  ( $config_arr['cfg_bgcolor2'] );
    $config_arr['cfg_bgcolor'] =  ( $config_arr['cfg_bgcolor'] );
    $config_arr['cfg_showplayer'] =  ( $config_arr['cfg_showplayer'] );
    $config_arr['cfg_showloading'] =  ( $config_arr['cfg_showloading'] );
    $config_arr['cfg_playercolor'] =  ( $config_arr['cfg_playercolor'] );
    $config_arr['cfg_loadingcolor'] =  ( $config_arr['cfg_loadingcolor'] );
    $config_arr['cfg_buttoncolor'] =  ( $config_arr['cfg_buttoncolor'] );
    $config_arr['cfg_buttonovercolor'] =  ( $config_arr['cfg_buttonovercolor'] );
    $config_arr['cfg_slidercolor1'] =  ( $config_arr['cfg_slidercolor1'] );
    $config_arr['cfg_slidercolor2'] =  ( $config_arr['cfg_slidercolor2'] );
    $config_arr['cfg_sliderovercolor'] =  ( $config_arr['cfg_sliderovercolor'] );
    $config_arr['cfg_buffermessage'] =  ( $config_arr['cfg_buffermessage'] );
    $config_arr['cfg_buffercolor'] =  ( $config_arr['cfg_buffercolor'] );
    $config_arr['cfg_bufferbgcolor'] =  ( $config_arr['cfg_bufferbgcolor'] );
    $config_arr['cfg_titlecolor'] =  ( $config_arr['cfg_titlecolor'] );
    $config_arr['cfg_onclick'] =  ( $config_arr['cfg_onclick'] );
    $config_arr['cfg_ondoubleclick'] =  ( $config_arr['cfg_ondoubleclick'] );
    $config_arr['cfg_showmouse'] =  ( $config_arr['cfg_showmouse'] );
    $config_arr['cfg_iconplaycolor'] =  ( $config_arr['cfg_iconplaycolor'] );
    $config_arr['cfg_iconplaybgcolor'] =  ( $config_arr['cfg_iconplaybgcolor'] );
    $config_arr['cfg_top1_url'] =  ( $config_arr['cfg_top1_url'] );
