<!--section-start::SYSTEMMESSAGE-->
<b>{..message_title..}</b><br>
{..message..}
<!--section-end::SYSTEMMESSAGE-->

<!--section-start::FORWARDMESSAGE-->
<b>{..message_title..}</b><br>
{..message..}<br>
...
<!--section-start::DOCTYPE-->
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<!--section-end::DOCTYPE-->


<!--section-start::MAINPAGE-->
<body>
...
<!--section-end::PICTUREVIEWER-->


<!--section-start::ANNOUNCEMENT-->
<b>Ankündigung:</b>
<br><br>
    {announcement_text}
<br><br>
