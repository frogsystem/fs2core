<?php
/**
 * @file     class_searchIndex.php
 * @folder   /libs
 * @version  0.2
 * @author   Sweil
 *
 * this class is responsible for searchIndex operations
 */
class SearchIndex extends Search {
    ...
    protected function compressSearchData ( $TEXT ) {
        ...
        $locSearch[] = "=([^A-Za-z0-9])=";
        $locSearch[] = "= +=";
        #$locSearch[] = "=([0-9/.,+-]*\s)=";  //uncommt to disable support for numbers in searchindex
        ...
        $locReplace[] = " ";
        $locReplace[] = " ";
        #$locReplace[] = " "; //uncommt to disable support for numbers in searchindex
