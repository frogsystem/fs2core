    ...
    )
{
    if ( $_POST['user_group_delete'] == 1 ) {
        ...
        $message = "Gruppe wurde nicht gelöscht";
    }
        ...
        echo'
                            ...
                            <tr>
                                <td class="config">
                                    ...
                                    <span class="small">'."Ein kurzer Text über die Gruppe.".'</span>
                                </td>
                                <td class="config">
    ...
    elseif ( $_POST['group_action'] == "delete" && $_POST['user_group_id'] != 0 )
    {
        ...
        echo '
                    <form action="" method="post">
                        ...
                        <input type="hidden" name="go" value="group_admin">
                        <table class="configtable" cellpadding="4" cellspacing="0">
                            <tr><td class="line" colspan="2">'."Gruppe löschen".'</td></tr>
                            <tr>
                                <td class="configthin" style="width: 100%;">
                                    '."Soll diese Gruppe wirklich gelöscht werden:".' <b>'.$group_arr['user_group_name'].'</b>
...
else
{
    ...
    echo '
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="go" value="group_admin">
                        <table class="configtable" cellpadding="4" cellspacing="0">
                            <tr><td class="line" colspan="2">'."Gruppe hinzufügen".'</td></tr>
                            <tr>
                                <td class="config">
