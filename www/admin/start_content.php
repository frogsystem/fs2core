...
if ( $num_news  > 0 ) {
	echo '
                            <tr>
                                <td class="configthin">Grˆﬂte Kategorie:</td>
	...
	echo '
							...
							<tr>
                                <td class="configthin">Fleiﬂigster News-Poster:</td>
	...
	if ( $num_comments  > 0 ) {
		echo '
                            <tr>
                                <td class="configthin">Fleiﬂigster Kommentar-Poster:</td>
...
if ( $num_articles  > 0 && $best_article_poster_num > 0 ) {
	echo '
							<tr>
                                <td class="configthin">Fleiﬂigster Artikel-Autor:</td>
...
if ( $num_press  > 0 ) {
	echo '
							<tr>
                                <td class="configthin">H‰ufigste Sprache:</td>
