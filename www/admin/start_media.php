...
if ( $num_gallery_img > 0 ) {
    $index = $FD->sql()->conn()->query ( "
					...
					LIMIT 0,1' );
    $row = $index->fetch(PDO::FETCH_ASSOC);
    $best_gallery = stripslashes ( $row['cat_name'] );
...
if ( $num_gallery_wp > 0 ) {
	$index = $FD->sql()->conn()->query ( "
					...
					LIMIT 0,1' );
    $row = $index->fetch(PDO::FETCH_ASSOC);
	$best_gallery2 = stripslashes ( $row['cat_name'] );
...
if ( $num_dl  > 0 && $num_dl_files  > 0 ) {
    $index = $FD->sql()->conn()->query ( "
					...
					LIMIT 0,1' );
    $row = $index->fetch(PDO::FETCH_ASSOC);
    $best_dl_files = stripslashes ( $row['dl_name'] );
    ...
    $index = $FD->sql()->conn()->query ( "
					...
					LIMIT 0,1' );
    $row = $index->fetch(PDO::FETCH_ASSOC);
    $best_dl_count = stripslashes ( $row['dl_name'] );
    ...
    $index = $FD->sql()->conn()->query ( "
					...
					LIMIT 0,1' );
    $row = $index->fetch(PDO::FETCH_ASSOC);
    $best_dl_traffic = stripslashes ( $row['dl_name'] );
    ...
    $index = $FD->sql()->conn()->query ( "
					...
					LIMIT 0,1' );
    $row = $index->fetch(PDO::FETCH_ASSOC);
    $best_dl_uploader = stripslashes ( $row['user_name'] );
