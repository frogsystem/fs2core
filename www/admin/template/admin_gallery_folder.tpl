...
<!--DEF::edit-->                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <table class="configtable" cellpadding="4" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="input_width_big" name="cat_subcat_of" size="1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="input_width_big" name="cat_type" size="1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="input_width_big" name="cat_visibility" size="1">
                            ...
                            <tr>
                                ...
                                <td class="config">
                                    <input type="date" class="text input_width_mini" size="15" maxlength="10" id="cat_date_format" name="cat_date_format" value="<!--TEXT::cat_date_format-->">
                                    <input type="hidden" id="cat_date" name="cat_date" value="<!--TEXT::cat_date_format-->">
                                    <!--TEXT::today-->
                                    <!--TEXT::reset_date-->
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="config">
                                    <input name="cat_img" type="file" class="text full_width" size="35"><br>
                                <!--IF::image_exists?true-->
                            ...
                            <tr>
                                <td class="buttontd" colspan="2">
                                    <button type="submit" name="sended" value="edit" class="button_new">
                                        <!--COMMON::button_arrow-->
