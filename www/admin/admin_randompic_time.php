   ...
   )
{
    ...
    {
        $FD->db()->conn()->exec('DELETE FROM '.$FD->config('pref')."screen_random WHERE random_id = '$_POST[random_id]'");
       ...
       )
{
    ...
    $index = $FD->db()->conn()->query('SELECT * FROM '.$FD->config('pref')."screen_random WHERE random_id = $_POST[random_id]");
       ...
       )
{
    ...
    $index = $FD->db()->conn()->query('SELECT screen_name FROM '.$FD->config('pref')."screen WHERE screen_id = $random_arr[screen_id]");
...
if (!isset($_POST['random_id']))
{
    ...
    ';
    $index = $FD->db()->conn()->query('SELECT * FROM '.$FD->config('pref').'screen_random a, '.$FD->config('pref').'screen b WHERE a.screen_id = b.screen_id ORDER BY a.end DESC');
